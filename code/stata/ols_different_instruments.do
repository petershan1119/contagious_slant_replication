...
reghdfe St_percent_fox St_cons_fox_cnn_msnbc $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
estadd scalar ftest=e(widstat)
eststo
...
eststo clear
global controls $covs_base
reghdfe St_percent_fox St_cons_fox_cnn $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
estadd scalar ftest=e(widstat)
eststo
global controls $covs_base $channel
reghdfe St_percent_fox St_cons_fox_cnn $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
...
eststo clear
global controls $covs_base
reghdfe St_percent_fox St_cons_fox_msnbc $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
estadd scalar ftest=e(widstat)
eststo
global controls $covs_base $channel
reghdfe St_percent_fox St_cons_fox_msnbc $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
...
eststo clear
global controls $covs_base
reghdfe St_percent_fox St_rtgxx_county_fxnc $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
estadd scalar ftest=e(widstat)
eststo
global controls $covs_base $channel
reghdfe St_percent_fox St_rtgxx_county_fxnc $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
