...
gen instr_fox_msnbc=pos_fxnc_county_repl-pos_mnbc_county_repl
...
reghdfe St_percent_fox St_instr_fox_cnn_msnbc $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
estadd scalar ftest=e(widstat)
eststo
...
estadd scalar ftest=e(widstat)
eststo
esttab, stats(ftest r2 N, fmt(%9.3f %9.3f %9.0g) labels("F-test" "R$^2$" "N observations")) starlevels(* 0.1 ** 0.05 *** 0.01) keep(St_instr_fox_cnn_msnbc) cells(b(star fmt (%9.3f)) se(par))
esttab using "results/main_`ext'_instr1.tex", replace keep(St_instr_fox_cnn_msnbc) label order() collabels(, none) ml(,none) cells(b(star fmt (%9.3f)) se(par)) stats(ftest r2 N, fmt(%9.3f %9.3f %9.0g) labels("F-test" "R$^2$" "N observations")) starlevels(* 0.10 ** 0.05 *** 0.01) 


eststo clear
global controls $covs_base
reghdfe St_percent_fox St_instr_fox_cnn $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
estadd scalar ftest=e(widstat)
eststo
global controls $covs_base $channel
reghdfe St_percent_fox St_instr_fox_cnn $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
...
estadd scalar ftest=e(widstat)
eststo
esttab, stats(ftest r2 N, fmt(%9.3f %9.3f %9.0g) labels("F-test" "R$^2$" "N observations")) starlevels(* 0.1 ** 0.05 *** 0.01) keep(St_instr_fox_cnn) cells(b(star fmt (%9.3f)) se(par))
esttab using "results/main_`ext'_instr2.tex", replace keep(St_instr_fox_cnn) label order() collabels(, none) ml(,none) cells(b(star fmt (%9.3f)) se(par)) stats(ftest r2 N, fmt(%9.3f %9.3f %9.0g) labels("F-test" "R$^2$" "N observations")) starlevels(* 0.10 ** 0.05 *** 0.01) 


eststo clear
global controls $covs_base
reghdfe St_percent_fox St_instr_fox_msnbc $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
estadd scalar ftest=e(widstat)
eststo
global controls $covs_base $channel
reghdfe St_percent_fox St_instr_fox_msnbc $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
...
estadd scalar ftest=e(widstat)
eststo
esttab, stats(ftest r2 N, fmt(%9.3f %9.3f %9.0g) labels("F-test" "R$^2$" "N observations")) starlevels(* 0.1 ** 0.05 *** 0.01) keep(St_instr_fox_msnbc) cells(b(star fmt (%9.3f)) se(par))
esttab using "results/main_`ext'_instr3.tex", replace keep(St_instr_fox_msnbc) label order() collabels(, none) ml(,none) cells(b(star fmt (%9.3f)) se(par)) stats(ftest r2 N, fmt(%9.3f %9.3f %9.0g) labels("F-test" "R$^2$" "N observations")) starlevels(* 0.10 ** 0.05 *** 0.01) 


eststo clear
global controls $covs_base
reghdfe St_percent_fox St_pos_fxnc_county_repl $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
estadd scalar ftest=e(widstat)
eststo
global controls $covs_base $channel
reghdfe St_percent_fox St_pos_fxnc_county_repl $controls [aweight=circ], absorb(fips_state) cluster(`cluster_vars'), if in_main
...
estadd scalar ftest=e(widstat)
eststo
esttab, stats(ftest r2 N, fmt(%9.3f %9.3f %9.0g) labels("F-test" "R$^2$" "N observations")) starlevels(* 0.1 ** 0.05 *** 0.01) keep(St_pos_fxnc_county_repl) cells(b(star fmt (%9.3f)) se(par))
esttab using "results/main_`ext'_instr4.tex", replace keep(St_pos_fxnc_county_repl) label order() collabels(, none) ml(,none) cells(b(star fmt (%9.3f)) se(par)) stats(ftest r2 N, fmt(%9.3f %9.3f %9.0g) labels("F-test" "R$^2$" "N observations")) starlevels(* 0.10 ** 0.05 *** 0.01) 
